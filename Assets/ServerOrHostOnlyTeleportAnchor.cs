...
public class ServerOrHostOnlyTeleportAnchor : NetworkBehaviour
{
    [Header("Optional extra visuals to hide")]
    ...
    private void ApplyVisibilityAndAccess()
    {
        ...
        bool allow = NetworkManager.Singleton.IsServer;   // true for Host and Dedicated Server
